...
namespace amorphie.user;
    ...
    public abstract class BaseUserSecurityQuestionModule<TDTOModel, TDBModel, TValidator>
    ...
    {
        protected BaseUserSecurityQuestionModule(WebApplication app) : base(app)
        {
        }
